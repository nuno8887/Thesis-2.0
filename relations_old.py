...
# Example text
text = "She placed nearly three books on the shelf and almost four pens in the more than 5 drawer."
        ...
        if token.dep_ == "pobj" and not token.like_num:
            ...
            for child in token.children:
                if child.dep_ == "nummod":
                    ...
                    print(f"Children of {child.text}: {[c.text for c in child.children]}")
